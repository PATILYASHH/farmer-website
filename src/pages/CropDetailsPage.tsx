        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <header className="bg-white border-b border-gray-200 shadow-sm">
                <div className="max-w-2xl mx-auto px-4 py-4 md:py-6">
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Crop Details</h1>
            ...
            <div className="max-w-2xl mx-auto px-4 py-4 md:py-6">
                <div className="bg-white rounded-xl md:rounded-2xl shadow-lg p-4 md:p-8 border border-gray-200">
                    ...
                    <div className="bg-blue-50 border-2 border-blue-200 rounded-xl md:rounded-2xl p-4 md:p-6 mb-6 md:mb-8">
                        <div className="grid grid-cols-2 gap-3 md:gap-4">
                            <div>
                                ...
                                <p className="text-sm md:text-lg font-bold text-blue-900">{farmer.fullName}</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p className="text-sm md:text-lg font-bold text-blue-900">{farmer.location?.village}</p>
                            </div>
                            <div>
                                <p className="text-xs text-blue-600 uppercase font-semibold">District</p>
                                <p className="text-sm md:text-lg font-bold text-blue-900">{farmer.location?.district}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-5 md:space-y-6">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-3">
                                {CROP_TYPES.map(crop => (
                                    <button
                                        ...
                                        className={`p-3 md:p-4 text-sm md:text-base rounded-lg border-2 font-semibold transition ${
                        ...
                        {formData.cropType && (
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full px-3 md:px-4 py-2.5 md:py-3 text-sm md:text-base border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none transition"
                                >
                        ...
                        {/* Error Message */}
                        {error && (
                            <div className="bg-red-50 border-2 border-red-200 text-red-700 px-3 md:px-4 py-2 md:py-3 rounded-lg text-xs md:text-sm">
                                {error}
                            </div>
                        )}
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="w-full flex items-center justify-center gap-2 px-4 md:px-6 py-3 md:py-4 text-sm md:text-base bg-primary-600 hover:bg-primary-700 text-white font-bold rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed mt-6 md:mt-8"
                        >
